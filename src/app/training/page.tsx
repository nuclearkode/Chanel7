            ...
            <div className="relative flex min-h-screen w-full">
                ...
                <SidebarInset>
                    <div className="p-4 sm:p-6 lg:p-8 flex flex-col h-full">
                        ...
                        <Tabs defaultValue="accord" className="w-full">
                            <TabsList className="grid w-full grid-cols-3">
                                <TabsTrigger value="accord">Accord Suggestion</TabsTrigger>
                                <TabsTrigger value="fixative">Fixative Recommendation</TabsTrigger>
                                <TabsTrigger value="sensitivity">Sensitivity Profile</TabsTrigger>
                            </TabsList>
