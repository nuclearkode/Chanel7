...
<?php
    ...
    if ($platform !== "CLOUD") {
        ...
        echo '<div class="mt-4 alert alert-danger"><i class="fa-solid fa-circle-exclamation mx-2"></i>System logs access is disabled by configuration. See our <a href="README.md" target="_blank">README.md</a> for more information</div>';
    } else {
?>
